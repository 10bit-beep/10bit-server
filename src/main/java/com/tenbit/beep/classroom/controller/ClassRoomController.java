...
public class ClassRoomController {
    ...
    @GetMapping("/search")
    public ResponseEntity<ClassRoomResponse> getById(@RequestParam Long id) {
    ...
    @GetMapping("/grade")
    public ResponseEntity<List<ClassRoomResponse>> getByGrade(@RequestParam int grade) {
    ...
    public ResponseEntity<List<ClassRoomResponse>> getByGradeAndClass(@RequestParam int grade,
    ...
    public ResponseEntity<List<ClassRoomResponse>> searchByName(@RequestParam String className) {
        List<ClassRoomResponse> classRooms = repository.findByClassNameContaining(className).stream()
                .map(ClassRoomResponse::from)
                .collect(Collectors.toList());
        return ResponseEntity.ok(classRooms);
    }
    ...
    @PutMapping
    public ResponseEntity<ClassRoomResponse> update(@RequestParam Long id,
